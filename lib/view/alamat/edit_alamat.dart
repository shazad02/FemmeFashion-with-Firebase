...
class EditAlamatt extends StatefulWidget {
  const EditAlamatt({super.key});

  @override
  _EditAlamattState createState() => _EditAlamattState();
}

class _EditAlamattState extends State<EditAlamatt> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: Text(
          'Alamat',
          style: primaryTextStyle3.copyWith(fontSize: 22, color: bg2Color),
        ),
        leading: IconButton(
            onPressed: () {
...
class _AddressFormDialogState extends State<AddressFormDialog> {
  ...
  Widget build(BuildContext context) {
    ...
    return AlertDialog(
      title: const Text('Masukan Alamat Kamu'),
      content: Form(
        key: _formKey,
